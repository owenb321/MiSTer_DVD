...
module transport_hud_tb;
    ...
    initial begin
        ...
        seek_fwd = 1; seek_min = 0; seek_sec = 3; seek_evt = 1; @(posedge clk); seek_evt = 0;
        check_popup("T18a seek fwd 0:30", "SEEK FWD  0:30~~~~~~~~~~~~~~~~~~");
        seek_fwd = 0; seek_min = 1; seek_sec = 0; seek_evt = 1; @(posedge clk); seek_evt = 0;
        check_popup("T18b seek back 1:00", "SEEK BACK 1:00~~~~~~~~~~~~~~~~~~");
        seek_fwd = 1; seek_min = 12; seek_sec = 3; seek_evt = 1; @(posedge clk); seek_evt = 0;
        check_popup("T18c seek fwd 12:30", "SEEK FWD  12:30~~~~~~~~~~~~~~~~~");
        seek_fwd = 0; seek_min = 99; seek_sec = 5; seek_evt = 1; @(posedge clk); seek_evt = 0;
        check_popup("T18d seek back 99:50", "SEEK BACK 99:50~~~~~~~~~~~~~~~~~");

        // ---- T19: the seek popup is a USER event, never preempted ------
        seek_fwd = 1; seek_min = 0; seek_sec = 1; seek_evt = 1; @(posedge clk); seek_evt = 0;

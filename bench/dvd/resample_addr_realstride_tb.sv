...
module resample_addr_realstride_tb;
  ...
  resample_addrgen dut (
    ...
    .busy(busy), .video_live(), .pickup_hold(1'b0), .pause(1'b0), .step_req(1'b0), .raster_par_err(1'b0), .vscale_mode(2'd0), .hcrop_en(1'b0), .still_en(1'b0), .blend_en(1'b0), .sched_due(1'b1), .sched_next_due(1'b1));

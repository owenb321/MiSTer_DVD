...
**SMPTE is the default**. Rebased onto main after PR #63 (the free-running STC); build
`DVD_smptesync3_20260907_2053.rbf`, SEED 5 first roll, clk_dec 93.35 @100C / 89.89 @-40C
(gate 86.0), 93 % ALM.
